  ...
  const features = [
      {
          ...
          title: "Simulas",
          desc: "Encontre várias ofertas de seguros indicadas para ti."
      },
      {
          icon:
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          title: "Compras",
          desc: "Entre várias seguradoras ao mesmo tempo."
      },
      {
          icon:
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          title: "Subscreves",
          desc: "E ficas com toda a info e documentação na tua área reservada."
      },
  ]
